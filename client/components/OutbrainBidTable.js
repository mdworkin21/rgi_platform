  ...
  return (
    <table className="ui celled table" id="bid-table-container" >
        <thead>
          ...
          <tr>
            <th colSpan="1" className='center aligned' id='bid-table-header'>Section Name</th>
            <th colSpan="1" className='center aligned' id='bid-table-header'>Section ID</th>
            ...
            <th colSpan="1" className='center aligned' id='bid-table-header'>Modifier</th>
          </tr>
        </thead>
        <tbody id="table-body">
